...
# -*- coding: utf-8 -*-
#
# ipygg documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipygg', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipygg.tex', 'ipygg Documentation',
     'QuantStack', 'manual'),
]
